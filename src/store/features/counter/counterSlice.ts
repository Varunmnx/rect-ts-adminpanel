...
export const sampleThunk = createAsyncThunk('counter/sampleThunk', async (params:SampleCounterBody, thunkAPI) => {
  try {
    //create a promise
    console.log(params)
...
export const counterSlice = createSlice({
  ...
  extraReducers:(builder) => {
    ...
    .addCase(sampleThunk.rejected, (_state, _action) => {
       ...
       console.log('%cThis is a styled message', 'color: red; font-size: 16px;');
       
    }) 
    .addCase(sampleThunk.pending, (_state, _action) => {
        console.log('%cThis is a styled message', 'color: yellow; font-size: 16px;');
    })
  }
});
