export class GlobalErrorHandler {
    ...
    public static of(error: Error): GlobalErrorHandler {
      ...
      return new GlobalErrorHandler(error.message || "Unknown error occurred", errorCode);
    }
     ...
     */
    public static fromResponse(response: { message: string; code?: number }): GlobalErrorHandler {
